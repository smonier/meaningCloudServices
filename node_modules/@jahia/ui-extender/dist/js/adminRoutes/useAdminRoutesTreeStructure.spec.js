...
var _useAdminRoutesTreeStructure = require("./useAdminRoutesTreeStructure");
...
describe('useAdminRoutesTreeStructure', function () {
  ...
  it('should get the items', function () {
    _registry.registry.addOrReplace('adminRoute', 'route1', {
      targets: ['test:1'],
      isSelectable: false,
      label: 'test route 1'
    });
    _registry.registry.addOrReplace('adminRoute', 'route2', {
      targets: ['test:2'],
      isSelectable: true,
      label: 'test route 2'
    });
    _registry.registry.addOrReplace('adminRoute', 'route3', {
      targets: ['test:3'],
      isSelectable: true,
      label: 'test route 3'
    });
    var _useAdminRouteTreeStr = (0, _useAdminRoutesTreeStructure.useAdminRouteTreeStructure)('test'),
  ...
  it('should create a tree', function () {
    _registry.registry.addOrReplace('adminRoute', 'mainRoute', {
      targets: ['test:1'],
      isSelectable: false,
      label: 'test route 1'
    });
    _registry.registry.addOrReplace('adminRoute', 'subroute-2', {
      targets: ['test-mainRoute:1'],
      isSelectable: true,
      label: 'test route 2'
    });
    _registry.registry.addOrReplace('adminRoute', 'subroute-3', {
      targets: ['test-mainRoute:2'],
      isSelectable: true,
      label: 'test route 3'
    });
    var _useAdminRouteTreeStr2 = (0, _useAdminRoutesTreeStructure.useAdminRouteTreeStructure)('test'),
  ...
  it('should open the tree', function () {
    ...
    _registry.registry.addOrReplace('adminRoute', 'subroute', {
      targets: ['test-mainRoute:1'],
      isSelectable: true,
      label: 'test route 2'
    });
    _registry.registry.addOrReplace('adminRoute', 'subsubroute', {
      targets: ['test-subroute:1'],
      isSelectable: true,
      label: 'test route 3'
    });
    var _useAdminRouteTreeStr3 = (0, _useAdminRoutesTreeStructure.useAdminRouteTreeStructure)('test', 'subsubroute'),
  ...
  it('should gather permissions', function () {
    ...
    var _useAdminRouteTreeStr4 = (0, _useAdminRoutesTreeStructure.useAdminRouteTreeStructure)('test', 'subsubroute'),
  ...
  it('should filter tree', function () {
    ...
    var _useAdminRouteTreeStr5 = (0, _useAdminRoutesTreeStructure.useAdminRouteTreeStructure)('test'),
  ...
  it('should map tree', function () {
    ...
    var _useAdminRouteTreeStr6 = (0, _useAdminRoutesTreeStructure.useAdminRouteTreeStructure)('test'),
